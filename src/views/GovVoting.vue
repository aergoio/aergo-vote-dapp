<template>
  <div>
    <Vertical base="fill">
      <ViewTitle><p style="float:left">Gorvernanace Voting</p> <p style="float:right;font-size:small"><button type="button" class="component button button-primary button-uppercase">New Proposal</button></p></ViewTitle>
      <Island>
